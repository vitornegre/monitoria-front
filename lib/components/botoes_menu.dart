            ...
            child: Container(
              ...
              child: TextButton(
                ...
                child: const Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Icon(Icons.calendar_today, color: Colors.white, size: 70),
                    Text('Horário dos Monitores', style: TextStyle(color: Colors.white, fontSize: 26,),textAlign: TextAlign.center),
                  ],
                )
              ),
            ),
              ...
              child: TextButton(
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    Text('Exercícios', style: TextStyle(color: Colors.white, fontSize: 26,),textAlign: TextAlign.center),
                  ],
                )
              ),
            ),
              ...
              child: TextButton(
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    Text('Ranking', style: TextStyle(color: Colors.white, fontSize: 26),textAlign: TextAlign.center),
                  ],
                )
              ),
            ),
              ...
              child: TextButton(
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    Text('Área do Monitor', style: TextStyle(color: Colors.white, fontSize: 26),textAlign: TextAlign.center),
                  ],
                )
              ),
            ),
